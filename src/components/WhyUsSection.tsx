...
const checkItems = [
  ...
  'Montaža u garažnih vrata na teritoriji opštine grada Subotica',
          ...
          <div className="why-grid">
            ...
            <div>
              <div style={{ marginBottom: '36px' }}>
                ...
                <p style={{ fontSize: '15px', color: '#ededeb', marginTop: '8px', maxWidth: '500px', fontFamily: "'Manrope', sans-serif" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', color: '#ffc02a', marginBottom: '12px', fontFamily: "'Space Grotesk', sans-serif" }}>
                Kontaktirajte nas
              </div>
              <div style={{ fontSize: 'clamp(24px, 3vw, 32px)', fontWeight: 800, color: '#f0f0f0', letterSpacing: '-1px', lineHeight: 1.15, marginBottom: '16px', fontFamily: "'Manrope', sans-serif" }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '32px' }}>
                {checkItems.map(item => (
                  <div key={item} style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px', color: '#ccc', fontFamily: "'Manrope', sans-serif" }}>
                    <div style={{
