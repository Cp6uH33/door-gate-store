...
export default function CategoriesSection() {
  ...
  return (
    <section id="categories" style={{ padding: '80px 0', background: '#1a1a1a' }}>
      <div style={{ maxWidth: '1152px', margin: '0 auto', padding: '0 24px' }} ref={sectionRef}>
        ...
        {loading && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '16px' }}>
            {[...Array(5)].map((_, i) => (
              <div key={i} style={{
                background: '#1a1a1a', borderRadius: '20px', height: '180px',
                border: '1.5px solid #222', animation: 'pulse 1.5s ease infinite',
              ...
              <Link key={cat.id} href={`/shop?cat=${cat.slug}`} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div className="cat-icon" style={{
                    ...
                    marginBottom: '18px', border: '1px solid #2a2a2a',
