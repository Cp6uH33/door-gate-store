    ...
    <>
      <section id="products" style={{ padding: '60px 0 80px', background: '#ededeb' }}>
        <div style={{ maxWidth: '1152px', margin: '0 auto', padding: '0 20px' }} ref={sectionRef}>
          ...
          {/* Header */}
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '20px', marginBottom: '32px', flexWrap: 'wrap' }}>
            <div>
              <span style={{
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '32px' }}>
            {filters.map(f => (
              <button
                ...
                onClick={() => setActive(f)}
                style={{
                  fontSize: '12px', padding: '7px 14px', borderRadius: '100px',
